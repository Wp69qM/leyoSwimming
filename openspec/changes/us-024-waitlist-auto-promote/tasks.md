...
**Spec coverage:** REQ-001 首位候补转正、多人仅首位、跳过无课时、跳过已取消
...
**Spec coverage:** REQ-001 取消事件触发转正流程
...
**Spec coverage:** REQ-002 无候补时通知关注用户
...
**Spec coverage:** REQ-001 用户其他 waiting 候补自动取消
