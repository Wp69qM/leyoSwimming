...
c = MCPClient()
try:
    c.call("initialize", {"protocolVersion":"2025-06-18","capabilities":{},"clientInfo":{"name":"list","version":"1.0"}})
    c.notify("notifications/initialized", {})
    pages = c.call("tools/call", {"name":"get_design_page_list","arguments":{"file_id":FILE_ID}})
