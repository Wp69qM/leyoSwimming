...
| v1.2 | 2026-07-31 | Dev | P1-15 修复：移除内容安全审核流程（§1.1 audit_status 字段 / §1.2 audit_status / §1.3 audit_status / §2.1 CONTENT_SECURITY_REJECTED / §6 审核服务 / §8 审核异常分支），对齐 PRD §5.5.5 #6 / D47「预览机制无需审核直接生效」 |
