...
**Spec coverage:** user-story §6.1 / §6.5 / §8.1 / §8.2 / §8.3 / §8.4

- [ ] **RED:** Write failing tests — active package frozen with refund_pending; refund_record created with pending_change; reserved bookings rejected; multiple packages handled; original_status preserved
...
**Spec coverage:** user-story §6.2 / §6.3 / §6.4 / §6.6
...
**Spec coverage:** user-story §6.6 / §8.4
