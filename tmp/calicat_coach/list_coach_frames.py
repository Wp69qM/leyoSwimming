...
CANVAS_ID = "ea7ec847-47bc-492e-a4b0-d86d9190d702"
...
c = MCPClient()
try:
    c.call("initialize", {"protocolVersion":"2025-06-18","capabilities":{},"clientInfo":{"name":"list-coach","version":"1.0"}})
    c.notify("notifications/initialized", {})
    pages = c.call("tools/call", {"name":"get_design_page_list","arguments":{"file_id":FILE_ID, "canvas_id":CANVAS_ID}})
