CREATE TABLE IF NOT EXISTS `package_template` (
    ...
    stroke_ids JSON DEFAULT NULL COMMENT '泳姿 ID 列表',
...
CREATE TABLE IF NOT EXISTS `package_template_image` (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    package_template_id BIGINT NOT NULL COMMENT '套餐模板 ID',
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    KEY idx_package_template_image_template (package_template_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='套餐模板图片表';
